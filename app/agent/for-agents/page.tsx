...
export const metadata = {
  ...
  description:
    "How to integrate with Graham Paasch's A2A Site Agent (card, endpoint, and code examples).",
};
    ...
    <section className="grid">
      <div className="card">
        ...
        <ul>
          ...
          <li>
            <code>{rpcUrl}</code> - JSON-RPC endpoint (supports streaming via SSE)
          </li>
        </ul>
...
`}</code>
        ...
        <p className="muted">
          Want your own agent listed in Graham&apos;s community crawl? Submit the form below (human
          contact preferred) and we&apos;ll reach out once you&apos;re added. Opt-outs are honored quickly -
          just ping the same channel or update <code>robots.txt</code>.
        </p>
        <A2AOptInForm />
        <p className="muted">
          ...
          <a
            href="https://www.grahampaasch.com/professional"
            target="_blank"
            rel="noreferrer"
          >
